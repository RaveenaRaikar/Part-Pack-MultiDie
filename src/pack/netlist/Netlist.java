...
public class Netlist{
	...
	public void read_blif(){
		...
		file = this.simulation.getStringValue("result_folder") + this.simulation.getStringValue("circuit") + "_" + this.simulation.getSimulationID() +"_die_" + this.partnum + ".blif";
		...
		if(this.OrigFile) {
			...
			for(String element:this.OrigOutputs) {
				Output.println("\nThe output in original netlist is " + element);
			}
		}
